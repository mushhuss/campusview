  ...
  render() {
    return (
      <div>
        ...
        //pass the delete campus function as a prop
...
const mapDispatch = (dispatch) => {
  return {
    ...
    deleteCampus: (campusId) => dispatch(deleteCampusThunk(campusId)),  // Dispatch deleteCampusThunk when delete button is clicked
  };
};
